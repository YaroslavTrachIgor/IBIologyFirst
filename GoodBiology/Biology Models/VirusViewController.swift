...
class VirusViewController: UIViewController {
    ...
    let letsread = "Let's read something about"
    ...
    func scheduleNotificatio(inSecond seconds: TimeInterval, completion: (Bool) -> ())
    {
        ...
        content.title = "Do You Want To Read Something About Viruses"
    ...
    @IBAction func VirusNot(_ sender: UIButton)
    {
    ...
    @IBOutlet weak var VirusOutletButton: UIButton!
    ...
    override func viewDidLoad() {
        ...
        VirusOutletButton.layer.shadowColor = UIColor.darkGray.cgColor
        VirusOutletButton.layer.shadowRadius = 4
        VirusOutletButton.layer.shadowOffset = CGSize(width: 0, height: 0)
        VirusOutletButton.layer.shadowOpacity = 0.5
    }
