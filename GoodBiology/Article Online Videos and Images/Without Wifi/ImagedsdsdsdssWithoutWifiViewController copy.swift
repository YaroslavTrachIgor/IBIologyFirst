...
class ImagesWitdsdsffdsewwdhoutWifiViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        imageScrollView = ImageScrollView(frame: view.bounds)
            ...
            let imagePath = Bundle.main.path(forResource: "photo-1541855951501-fc42a85d86d3", ofType: "jpg")!
