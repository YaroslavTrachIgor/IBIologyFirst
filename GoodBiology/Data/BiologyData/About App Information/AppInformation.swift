...
In version 4.0 there are a lot of new different additions:

1) Now all the buttons have been repainted in a new dark green color.

2) The colors of the shadows were completely changed, because of which the application began to look friendlier.

3) Many bugs fixed.

4) Added function to change text font in new articles.

5) Fixed bug with animation on «About App» screen.

6) Many new articles about Biology.

7) More support for iPhone 5S
"""
